...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.widget_sidebar.setMinimumSize(QtCore.QSize(250, 0))
        self.widget_sidebar.setStyleSheet(
            "background-color: #AECBE0;\n" "padding: 5px;"
        )
        self.widget_sidebar.setObjectName("widget_sidebar")
        self.verticalLayout_sidebar = QtWidgets.QVBoxLayout(self.widget_sidebar)
        self.verticalLayout_sidebar.setObjectName("verticalLayout_sidebar")
        self.label_logo = QtWidgets.QLabel(self.widget_sidebar)
        self.label_logo.setFocusPolicy(QtCore.Qt.WheelFocus)
        self.label_logo.setStyleSheet("padding-top: 20px;\n" "padding-bottom: 10px;")
        self.label_logo.setText("")
        self.label_logo.setPixmap(QtGui.QPixmap(".\\image/cropped-ccdilogo.png"))
        self.label_logo.setAlignment(QtCore.Qt.AlignCenter)
        self.label_logo.setObjectName("label_logo")
        self.verticalLayout_sidebar.addWidget(self.label_logo)
        self.label_logo_name = QtWidgets.QLabel(self.widget_sidebar)
        self.label_logo_name.setMinimumSize(QtCore.QSize(0, 0))
        self.label_logo_name.setStyleSheet(
            "font: 10pt;\n" "font: bold;\n" "padding: 0px;"
        )
        self.label_logo_name.setScaledContents(False)
        self.label_logo_name.setAlignment(QtCore.Qt.AlignCenter)
        self.label_logo_name.setWordWrap(True)
        self.label_logo_name.setObjectName("label_logo_name")
        self.verticalLayout_sidebar.addWidget(self.label_logo_name)
        self.label_logo_name2 = QtWidgets.QLabel(self.widget_sidebar)
        self.label_logo_name2.setStyleSheet(
            "font: 10pt;\n" "font: bold;\n" "padding: 0px;\n" "padding-bottom: 10px;"
        )
        self.label_logo_name2.setAlignment(QtCore.Qt.AlignCenter)
        self.label_logo_name2.setObjectName("label_logo_name2")
        self.verticalLayout_sidebar.addWidget(self.label_logo_name2)
        self.pushButton_back = QtWidgets.QPushButton(self.widget_sidebar)
        self.pushButton_back.setObjectName("pushButton_back")
        self.verticalLayout_sidebar.addWidget(self.pushButton_back)
        self.pushButton_home = QtWidgets.QPushButton(self.widget_sidebar)
        self.pushButton_home.setObjectName("pushButton_home")
        self.verticalLayout_sidebar.addWidget(self.pushButton_home)
        self.pushButton_nav_add = QtWidgets.QPushButton(self.widget_sidebar)
        self.pushButton_nav_add.setObjectName("pushButton_nav_add")
        self.verticalLayout_sidebar.addWidget(self.pushButton_nav_add)
        self.pushButton_nav_view = QtWidgets.QPushButton(self.widget_sidebar)
        self.pushButton_nav_view.setObjectName("pushButton_nav_view")
        self.verticalLayout_sidebar.addWidget(self.pushButton_nav_view)
        spacerItem = QtWidgets.QSpacerItem(
            20, 40, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Expanding
        )
        self.verticalLayout_sidebar.addItem(spacerItem)
        self.horizontalLayout_3.addWidget(self.widget_sidebar)
        ...
        self.scrollArea_view.setStyleSheet("")
        ...
        self.scrollAreaWidgetContents_view.setGeometry(QtCore.QRect(0, 0, 643, 729))
        self.scrollAreaWidgetContents_view.setObjectName(
            "scrollAreaWidgetContents_view"
        )
        ...
        self.comboBox_view.setStyleSheet("")
        ...
        self.tableView_view.setStyleSheet("border: none;")
        ...
        self.pushButton_addStudent.setStyleSheet("background: #EEF7FB;")
        ...
        self.pushButton_addTeacher.setStyleSheet("background: #EEF7FB;")
        ...
        self.pushButton_addDepartment.setStyleSheet("background: #EEF7FB;")
        ...
        self.pushButton_addCourse.setStyleSheet("background: #EEF7FB;")
        ...
        self.pushButton_addSubject.setStyleSheet("background: #EEF7FB;")
        ...
        self.pushButton_addBlock.setStyleSheet("background: #EEF7FB;")
        ...
        self.pushButton_addRoom.setStyleSheet("background: #EEF7FB;")
        ...
        self.pushButton_addRoomSched.setStyleSheet("background: #EEF7FB;")
        ...
        self.pushButton_addSubjectSched.setStyleSheet("background: #EEF7FB;")
        ...
        self.pushButton_enroll = QtWidgets.QPushButton(self.page_add)
        self.pushButton_enroll.setStyleSheet("background: #EEF7FB;")
        self.pushButton_enroll.setObjectName("pushButton_enroll")
        self.verticalLayout_3.addWidget(self.pushButton_enroll)
        ...
        self.stackedWidget_pages.addWidget(self.page_reports)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_logo_name.setText(_translate("MainWindow", "CCDI Legazpi Campus -"))
        self.label_logo_name2.setText(_translate("MainWindow", " Scheduling System"))
        self.pushButton_back.setText(_translate("MainWindow", "Back"))
        self.pushButton_home.setText(_translate("MainWindow", "Home"))
        self.pushButton_nav_add.setText(_translate("MainWindow", "Add"))
        self.pushButton_nav_view.setText(_translate("MainWindow", "View"))
        ...
        self.pushButton_addDepartment.setText(
            _translate("MainWindow", "Add Department")
        )
        ...
        self.pushButton_addRoomSched.setText(
            _translate("MainWindow", "Add Room Schedule")
        )
        self.pushButton_addSubjectSched.setText(
            _translate("MainWindow", "Add Subject Schedule")
        )
        self.pushButton_enroll.setText(_translate("MainWindow", "Enroll"))
