...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.verticalLayout_sidebar.addWidget(self.pushButton_hide)
        ...
        self.scrollAreaWidgetContents_view.setGeometry(QtCore.QRect(0, 0, 627, 675))
        ...
        self.pushButton_addStudents = QtWidgets.QPushButton(self.page_add)
        self.pushButton_addStudents.setObjectName("pushButton_addStudents")
        self.verticalLayout_3.addWidget(self.pushButton_addStudents)
        self.pushButton_addTeachers = QtWidgets.QPushButton(self.page_add)
        self.pushButton_addTeachers.setObjectName("pushButton_addTeachers")
        self.verticalLayout_3.addWidget(self.pushButton_addTeachers)
        ...
        self.pushButton_addCourses = QtWidgets.QPushButton(self.page_add)
        self.pushButton_addCourses.setObjectName("pushButton_addCourses")
        self.verticalLayout_3.addWidget(self.pushButton_addCourses)
        self.pushButton_addSubjets = QtWidgets.QPushButton(self.page_add)
        self.pushButton_addSubjets.setObjectName("pushButton_addSubjets")
        self.verticalLayout_3.addWidget(self.pushButton_addSubjets)
        self.pushButton_addBlocks = QtWidgets.QPushButton(self.page_add)
        self.pushButton_addBlocks.setObjectName("pushButton_addBlocks")
        self.verticalLayout_3.addWidget(self.pushButton_addBlocks)
        self.pushButton_addRooms = QtWidgets.QPushButton(self.page_add)
        self.pushButton_addRooms.setObjectName("pushButton_addRooms")
        self.verticalLayout_3.addWidget(self.pushButton_addRooms)
        ...
        self.gridLayout.addWidget(self.label_studentNo, 0, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.label_course, 0, 3, 1, 1)
        self.label_block = QtWidgets.QLabel(self.page_info)
        self.label_block.setObjectName("label_block")
        self.gridLayout.addWidget(self.label_block, 1, 3, 1, 1)
        self.verticalLayout_4.addLayout(self.gridLayout)
        self.tableView_class = QtWidgets.QTableView(self.page_info)
        self.tableView_class.setObjectName("tableView_class")
        self.verticalLayout_4.addWidget(self.tableView_class)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.pushButton_addStudents.setText(_translate("MainWindow", "Add Students"))
        self.pushButton_addTeachers.setText(_translate("MainWindow", "Add Teachers"))
        self.pushButton_addDepartment.setText(_translate("MainWindow", "Add Department"))
        self.pushButton_addCourses.setText(_translate("MainWindow", "Add Courses"))
        self.pushButton_addSubjets.setText(_translate("MainWindow", "Add Subjects"))
        self.pushButton_addBlocks.setText(_translate("MainWindow", "Add Blocks"))
        self.pushButton_addRooms.setText(_translate("MainWindow", "Add Rooms"))
